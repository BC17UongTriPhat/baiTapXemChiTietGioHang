                    ...
                    <div className='card-body'>
                        <div className='row'>
                            <div className='col-6'>
                                ...
                                <div className='form-group'>
                                    <p>Mật khẩu</p>
                                    <input className='form-control' id='matKhau' name='matKhau' value={matKhau} onChange={this.handleChangeInput} />
                            ...
                            <div className='col-6'>
                                <div className='form-group'>
                                    <p>Email</p>
                                    <input typeMeta="email" className='form-control' id='email' name='email' value={email} onChange={this.handleChangeInput} />
                                    <p className='text-danger'>{this.state.errors.email}</p>

                                </div>
                                <div className='form-group'>
                                    <p>Số điện thoại</p>
                                    <input className='form-control' id='soDienThoai' name='soDienThoai' value={soDienThoai} onChange={this.handleChangeInput} />
                                    <p className='text-danger'>{this.state.errors.soDienThoai}</p>

                                </div>
                                <div className='form-group'>
                                    <p>Loại người dùng</p>
                                    <select className='form-control' id='maLoaiNguoiDung' value={loaiNguoiDung} onChange={this.handleChangeInput} name='maLoaiNguoiDung'>
